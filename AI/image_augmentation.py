    ...
    for label in labels:
        for image in os.listdir(os.path.join(directory, label)):
            ...
            for x in range(number_of_augpics):
                ...
                plt.imsave(f'D:/dokument/skolskit/SIMS/Code/Sims/AI/aug_images/{label}/augmented_{file_name}_{i}.jpg',
                           augment_img['image'])  # Save img using matplotlib.pyplot lib.
                i += 1


directory = 'D:/dokument/skolskit/SIMS/Code/Sims/AI/Images'
number_of_augpics = 20
